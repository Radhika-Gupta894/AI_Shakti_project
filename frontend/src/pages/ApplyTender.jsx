...
import { FileUp, CheckCircle, AlertCircle, Trash2, Info, Loader2, Eye, X } from 'lucide-react';
  ...
  return (
    <BidderLayout>
      <div className="max-w-4xl mx-auto pb-20">
        ...
        <h3 className="font-black text-slate-800 text-lg mb-6 uppercase tracking-tight">Required Documents</h3>
        ...
        <div className="bg-white rounded-[32px] p-8 border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
           ...
           <button 
             ...
             disabled={submitting}
             className={`w-full md:w-auto px-10 py-4 rounded-2xl font-black text-sm transition-all flex items-center justify-center gap-3 ${
               submitting
